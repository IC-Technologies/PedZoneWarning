...
PerformHttpRequest("https://raw.githubusercontent.com/IC-Technologies/PedZoneWarning/version.txt", function(error, updatedVersion, headers)
	...
	if (updatedVersion ~= nil) then 
		...
		if (updatedVersion ~= currentVersion) then
			print('PedZoneWarning is outdated, go to https://github.com/IC-Technologies/PedZoneWarning/releases to get the latest version.')
			print("Current Version: " .. currentVersion)
			print("Latest Version: " .. updatedVersion)
		else
			print('PedZoneWarning is up to date!')
			print("Current Version: " .. currentVersion)
		end
	else 
